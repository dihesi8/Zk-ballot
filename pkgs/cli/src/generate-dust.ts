// pkgs/cli/src/generate-dust.ts
//
// Registers tNIGHT UTXOs for DUST generation, so the wallet can pay
// transaction fees. Adapted from Midnight's official bulletin-board CLI
// tutorial — unmodified for zk-ballot, this logic is contract-agnostic.
