// pkgs/cli/src/midnight-wallet-provider.ts
//
// Bridges the Wallet SDK to the Midnight.js contracts API. Adapted from
// Midnight's official bulletin-board CLI tutorial — unmodified for
// zk-ballot, this logic is contract-agnostic.
